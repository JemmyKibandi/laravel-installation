...
<br>
  ...
  <div class="grid grid-flow-col gap-5 text-center auto-cols-max">
   ...
   <footer class="footer footer-center p-10 bg-purple-300 text-black">
  <aside>
    <image src="{{ asset('images/logos.png') }}" style="width:50px; height:50px;">
<p class="font-bold">
    GemTech Creative. <br/>Providing reliable tech since, umm, *insert time and date you saw this.
    </p> 
