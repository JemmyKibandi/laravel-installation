<div>
    ...
    <div class="hero h-[50vh] relative">
     <!-- style="background-image: url(https://media.istockphoto.com/id/1173935107/photo/long-wave-on-the-coast-dawn-on-the-sea-tunisia.jpg?s=612x612&w=0&k=20&c=Q-O-34NjJpbiOtNlGGUGEllKATijp34X_xfZphY7VtE=);"> -->
  <div class="hero"></div>
  <div class="hero-content text-center text-neutral-content">
    <div class="max-w-md">
      <h1 id="header" class="mb-5 text-5xl text-black font-bold">Oh Hi there 👀!</h1>
      <p id="paragraph1" class="mb-5 text-black">Jemima Kibandi is an enthusiastic individual dedicated to expanding my knowledge and skills in web development.
   ...
   <center> <button class="btn text-black btn-primary flex items-center">
  Scroll to see More
